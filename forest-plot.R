...
print(reverse.printed.columns.order)
  #cat('reverse.printed.columns.order = ', reverse.printed.columns.order, '\n') # ADDED
  cat('reverse.printed.columns.order-length is: ', length(reverse.printed.columns.order), '\n') # ADDED
