...
```{r read data}
#Fst <- read.table("Fst_estimates.txt",header = T,sep="\t")
...
Fst <- read.table("data_Fst_18sp.txt",header = T,sep="\t")
y <- Fst$Fst
...
p22
p23
png("marker_type_wo_AFLP_RAPD.png")
p13
dev.off()
pdf("marker_type_wo_AFLP_RAPD.pdf")
p13
dev.off()
png("marker_type.png")
p1
dev.off()
#postscript("/mnt/powervault/jonhall/Desktop/SLU/marker_type.eps")
#p1
#dev.off()
png("marker_type_2.png")
p12
dev.off()
pdf("marker_type.pdf")
p1
...
p22
dev.off()
#postscript("Species_Fst_wo_AFLP_RAPD.eps")
#p23
#dev.off()
png("Species_Fst_wo_AFLP_RAPD.png")
p23
dev.off()
pdf("Species_Fst_wo_AFLP_RAPD.pdf")
p23
dev.off()
